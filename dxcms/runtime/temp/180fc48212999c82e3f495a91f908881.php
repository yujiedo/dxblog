<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\mumu\WWW\windowCms\public/../dxcms/app/admin\view\index\index.html";i:1586442565;s:61:"D:\mumu\WWW\windowCms\dxcms\app\admin\view\common\_style.html";i:1585897035;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
	<head>
		<meta charset="UTF-8">
	...
	<body class="dx-body">
		...
		<div class="footer layui-layer-molv">
			<div class="item-start">
				<i class="glyphicon glyphicon-th-large" title="开始" onclick="dx_openStart('<i style=\'margin-right:6px;\' class=\'glyphicon glyphicon-file\'></i> List-文档管理','<?php echo url('article/index'); ?>'),500,600"></i>
			</div>
		</div>
	</body>
