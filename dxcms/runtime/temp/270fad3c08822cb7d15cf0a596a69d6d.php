<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\mumu\WWW\windowCms\public/../dxcms/app/admin\view\category\category.html";i:1586015811;s:61:"D:\mumu\WWW\windowCms\dxcms\app\admin\view\common\_style.html";i:1585897035;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
        ...
        <table class="table table-hover">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                ...
                <td><i class="glyphicon glyphicon-folder-close icon-a" data-open="on"></i>
                    ...
                    <a href="javascript:;"
                       onclick="dx_openWindowParent('<i class=\'glyphicon glyphicon-folder-open\'></i>  文档列表 — <?php echo $item['title']; ?>','<?php echo url('article/index'); ?>?pid=<?php echo $item['id']; ?>')">
                        <?php echo $item['title']; ?>
                    </a>
