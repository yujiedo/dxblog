<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\mumu\WWW\windowCms\public/../dxcms/app/admin\view\admin\add.html";i:1585993074;s:61:"D:\mumu\WWW\windowCms\dxcms\app\admin\view\common\_style.html";i:1585897035;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
	<head>
		<meta charset="UTF-8">
...
<script src="/dxcms/js/dx-template.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		<div class="container-fluid dx-main">
			...
			<form action="<?php echo url('admin/save'); ?>" method="post" class="col-md-3 layui-form" style="height: auto;padding:20px 15px;">
				<div class="form-group">
					<label for="account">登录账号</label>
					<input type="text" class="form-control" name="account" value="" id="account" autocomplete="off">
				</div>
